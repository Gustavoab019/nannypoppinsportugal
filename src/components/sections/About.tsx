      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl bg-[#1A1A1A] p-8 lg:p-10 shadow-2xl">
              {/* Decorative gradient */}
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  <Link
                    ...
                    className="group flex w-full items-center justify-center gap-2 rounded-full bg-white px-8 py-4 text-base font-semibold text-gray-900 transition-all duration-200 hover:bg-gray-100 hover:shadow-lg"
                  >
                  ...
                  <a
                    ...
                    className="group flex w-full items-center justify-center gap-2 rounded-full border-2 border-white/20 px-8 py-4 text-base font-semibold text-white transition-all duration-200 hover:border-white/40 hover:bg-white/10"
                  >
                ...
                <div className="mt-8 pt-8 border-t border-white/10">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    >
                      <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#5BA8A2]/20 text-[#5BA8A2]">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        ...
                        <div className="text-sm font-medium text-white group-hover:text-[#7BBFB9] transition-colors">emma@nannypoppins.pt</div>
                      </div>
                    </a>
                    <a
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-sm font-medium text-white group-hover:text-[#7BBFB9] transition-colors">+351 916 592 174</div>
                      </div>
                    </a>
                  </div>
                </div>
